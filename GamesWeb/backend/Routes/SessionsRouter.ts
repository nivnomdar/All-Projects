...
SessionsRouter.get("/", async function(request, response){
...
SessionsRouter.post("/", async function(request, response){
...
SessionsRouter.delete("/", async function(request, response){
	try {
		if( request.session && request.session.role && request.session.role == "Admin" ){
