...
export enum SongActionType {
  ...
  downloadSongs = "downloadSongs", // להוריד ולקבל את כל השירים. יפעל פעם אחת לאורך כל האפליקצייה.
}
...
export function SongReducer(
  ...
  switch (action.type) {
    ...
    case SongActionType.downloadSongs: newState.allSongs = action.payload;
    break;
